...
export default function SiteHeader({
  ...
  return (
    <header className="sticky top-0 z-40 border-b backdrop-blur-lg" style={{ borderColor: 'var(--line)', backgroundColor: 'rgba(9,12,18,0.92)' }}>
      {/* Hidden anchors for NGF portal editor brand color pickers */}
      <span
      ...
      <nav className="mx-auto flex w-full max-w-6xl items-center justify-between px-4 py-4 sm:px-6 lg:px-8">
        ...
        <button
          ...
          className="inline-flex min-h-11 min-w-11 items-center justify-center rounded-xl border transition lg:hidden"
      ...
      {/* Mobile menu */}
      {menuOpen && (
        <div id="mobile-nav" className="border-t px-4 pb-5 pt-4 lg:hidden" style={{ borderColor: 'var(--line)' }}>
